...
exports.run = async (client, message, args) => {
    ...
    if(!queue.loopqueue.active) {
      queue.loopqueue.active = true;
      message.channel.send(`Acaba de activar la repeticion de la lista de canciones actuales.`)
    } else {
      queue.loopqueue.active = false;
      message.channel.send(`Acaba de desactivar la repeticion de la lista de canciones actuales.`)
    }
}
